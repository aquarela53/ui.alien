"WeakMap" in this || (function (module) {
	"use strict";
	...
	function WeakMap() {
		...
		return create(WeakMapPrototype, {
			...
			"delete": {
				value: bind.call(sharedDel, NULL, TRUE, keys, values)
			},
			//:was WeakMap#get(key:void*[, d3fault:void*]):void*
			// WeakMap#get(key:void*):void*
			get: {
				value: bind.call(sharedGet, NULL, TRUE, keys, values)
			},
			// WeakMap#has(key:void*):boolean
			has: {
				value: bind.call(sharedHas, NULL, TRUE, keys, values)
			},
			// WeakMap#set(key:void*, value:void*):void
			set: {
				value: bind.call(sharedSet, NULL, TRUE, keys, values)
			}
		});
	...
	function Map() {
		...
		return create(MapPrototype, {
			...
			"delete": {
				value: bind.call(sharedDel, NULL, FALSE, keys, values)
			},
			//:was Map#get(key:void*[, d3fault:void*]):void*
			// Map#get(key:void*):void*
			get: {
				value: bind.call(sharedGet, NULL, FALSE, keys, values)
			},
			// Map#has(key:void*):boolean
			has: {
				value: bind.call(sharedHas, NULL, FALSE, keys, values)
			},
			// Map#set(key:void*, value:void*):void
			set: {
				value: bind.call(sharedSet, NULL, FALSE, keys, values)
			}
		});
	...
	function Set() {
		...
		return create(SetPrototype, {
			...
			"delete": {
				value: bind.call(sharedDel, NULL, FALSE, values, keys)
			},
			...
			add: {
				value: bind.call(Set_add, NULL, FALSE, has, values)
			}
		});
	}
